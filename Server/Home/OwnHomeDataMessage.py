...
#            self.writeScId(29, int(i))
        ...
        self.writeInt(41000000 + random.randint(0,10))  # Theme ID
        ...
        self.writeString(f"RiseBrawl Made by RiseBunny™")
        ...
        if self.player.vip == 1:
            ...
            self.writeInt(0) # Time Ago
            self.writeString(f"RiseBrawl Vip'i aldığınız için teşekkür ederiz :)")
        ...
        self.writeVint(83)
        self.writeInt(0)
        self.writeBoolean(True) # True = no Popup # False = Popup
        self.writeInt(0)
        self.writeString("")
        self.writeInt(0)
        self.writeString("")
        ...
        self.writeString("brawlstars://extlink?page=https%3A%2F%2Ft.me%2Ftglinkhere")
        self.writeVint(3473)
        ...
        if self.player.low_id in settings['banID']:
            update_url = 'https://risebunny.github.io/brawl'
            self.player.err_code = 11
            LoginFailedMessage(self.client, self.player, 'Kalıcı olarak engellediniz! Hatalı bir ban söz konusumu? Yetkiliye ulaşın! - Discord: AhmetBs').send()
