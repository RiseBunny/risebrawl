...
def update_offers():
    ...
    # Mağaza konsolda güncellendi
    now = datetime.now()
    print(f"Mağaza güncellendi: {now.strftime('%Y-%m-%d %H:%M:%S')}")

# Kedinin saçmalıkları dükkanı güncelliyor
schedule.every().day.at("11:00").do(update_offers)

# Bitmesin diye sonsuz döngü.
while True:
